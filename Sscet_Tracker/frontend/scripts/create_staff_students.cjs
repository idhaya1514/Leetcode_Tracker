const fs = require('fs');
const path = 'c:/Users/idhay/Downloads/Leetcode_Tracker/Sscet_Tracker/frontend/src/app/components/StaffStudents.tsx';
                  ...
                  <tr key={student.id || idx} className="hover:bg-slate-50/50 transition-colors">
                    ...
                    <td className="px-5 py-3">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-medium text-slate-700">3 Solved</span>
                      </div>
                    </td>
                    <td className="px-5 py-3">
                      <div className="flex items-center gap-2">
...
console.log("Created StaffStudents.tsx");
