...
export default function AdminPanel({ onLogout, onNavigate }: AdminPanelProps) {
  ...
  const weeklyActivityData = [
    { name: "Mon", active: 40, previous: 35 },
    { name: "Tue", active: 55, previous: 45 },
    { name: "Wed", active: 30, previous: 50 },
    { name: "Thu", active: 70, previous: 60 },
    { name: "Fri", active: 45, previous: 40 },
    { name: "Sat", active: 20, previous: 15 },
    { name: "Sun", active: 35, previous: 25 },
  ];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-xl border border-slate-200/60 p-6 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.05)] h-full flex flex-col">
            ...
            <button className="mt-6 w-full py-2.5 bg-slate-50 hover:bg-slate-100 text-slate-600 text-sm font-medium rounded-lg transition-colors flex items-center justify-center gap-2">
...
console.log("Updated AdminPanel to Linear/Vercel aesthetic!");
