      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-2">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="px-4 py-2 bg-indigo-50 text-indigo-600 text-sm font-medium rounded-lg hover:bg-indigo-100 transition-colors shadow-sm flex items-center gap-2"
          >
            ...
            <table className="w-full text-left border-collapse">
              <thead className="bg-slate-50/80 border-b border-slate-200/60">
                <tr>
                  ...
                  <th className="px-5 py-3.5 text-left text-[11px] font-semibold text-slate-500 uppercase tracking-wider">Solved</th>
