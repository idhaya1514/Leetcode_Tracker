...
import { LayoutDashboard, Users, UserCog, Settings, Database, TrendingUp, CheckSquare } from 'lucide-react';
...
export default function AdminLayout({ onLogout }: { onLogout: () => void }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex">
      <Sidebar role="Admin" navItems={navItems} onLogout={onLogout} />
      <div className="flex-1 ml-64 flex flex-col h-screen">
        <Topbar userRole="Administrator" onLogout={onLogout} />
