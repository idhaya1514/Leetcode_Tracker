        ...
        <div className="p-6 flex items-start gap-4 hover:bg-slate-50/50 transition-colors">
          ...
          <div className="flex bg-slate-100 p-1 rounded-lg">
            <button 
              ...
              className={`px-3 py-1 text-xs font-semibold rounded shadow-sm transition-colors ${theme === 'light' ? 'bg-white text-slate-800' : 'text-slate-500 hover:text-slate-700'}`}
            >
              Light
            </button>
            <button 
              onClick={() => setTheme("dark")}
              className={`px-3 py-1 text-xs font-semibold rounded shadow-sm transition-colors ${theme === 'dark' ? 'bg-white text-slate-800' : 'text-slate-500 hover:text-slate-700'}`}
            >
              Dark
            </button>
          </div>
