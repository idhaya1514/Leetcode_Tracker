            ...
            {[
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p
                    className={`text-sm font-semibold text-slate-700 mt-0.5 truncate ${mono ? "font-mono" : ""}`}
                  >
                    {value}
                  </p>
                </div>
            ...
            <div className="flex items-center gap-2">
              {student.leetCodeUsername && (
                <>
                  ...
                  >
                    <RefreshCw
                      className={`w-3.5 h-3.5 ${leetLoading ? "animate-spin" : ""}`}
                    />
                  </button>
                </>
              )}
          ...
          {!student.leetCodeUsername && (
            ...
            >
              ...
              <p className="text-sm font-semibold text-slate-700">
                No LeetCode username linked
              </p>
              <p className="text-xs text-slate-500 mt-1 text-center max-w-xs">
                Register again with your LeetCode username to see your live
                stats here.
              </p>
            </div>
          )}
          ...
          {student.leetCodeUsername && !leetLoading && leetStats && (
            <div className="space-y-4">
                ...
                <div className="text-center">
                  ...
                  {leetStats.totalQuestions && (
                    <p className="text-xs font-semibold text-slate-550 mt-1">
                      out of {leetStats.totalQuestions.toLocaleString()}{" "}
                      problems
                    </p>
                  )}
              ...
              <div className="grid grid-cols-3 gap-3">
                {difficulties.map(
                  ({ label, solved, color, bg, border, icon: Icon }) => {
                    const pct =
                      totalForPct > 0
                        ? Math.round((solved / totalForPct) * 100)
                        : 0;
                    return (
                      <div
                        key={label}
